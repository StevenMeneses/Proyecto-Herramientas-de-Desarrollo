...
CREATE TABLE `producto_material` (
  ...
  CONSTRAINT `producto_material_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`),
  CONSTRAINT `producto_material_ibfk_2` FOREIGN KEY (`idMaterial`) REFERENCES `material` (`idMaterial`)
...
-- Dump completed on 2025-09-10 22:09:22
