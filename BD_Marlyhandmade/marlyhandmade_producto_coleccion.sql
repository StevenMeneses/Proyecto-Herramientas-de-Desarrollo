...
CREATE TABLE `producto_coleccion` (
  ...
  PRIMARY KEY (`idProducto`,`idColeccion`),
  KEY `idColeccion` (`idColeccion`),
  CONSTRAINT `producto_coleccion_ibfk_1` FOREIGN KEY (`idProducto`) REFERENCES `producto` (`idProducto`),
  CONSTRAINT `producto_coleccion_ibfk_2` FOREIGN KEY (`idColeccion`) REFERENCES `coleccion` (`idColeccion`)
...
-- Dump completed on 2025-09-10 22:09:20
