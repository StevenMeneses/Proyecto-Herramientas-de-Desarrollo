...
import GestionVentas from './pages/GestionVentas'; // ← IMPORT AÑADIDO
      ...
      <div className="app-container">
        ...
        <header className="top-header">
          <div className="header-container">
            ...
            <div className="right-section">
              <Link to="/favoritos" className="icon-link" title="Favoritos">
        ...
        {isMenuOpen && (
          <div className="mobile-menu">
            ...
            <div className="mobile-user-menu">
              ...
              <Link to="/favoritos" onClick={() => setIsMenuOpen(false)}><i className="fas fa-heart"></i> Favoritos</Link>
              <Link to="/carrito" onClick={() => setIsMenuOpen(false)}><i className="fas fa-shopping-cart"></i> Carrito</Link>
        ...
        <main className="main-content">
          <Routes>
            ...
            <Route path="/gestion-ventas" element={<GestionVentas />} /> {/* ← RUTA AÑADIDA */}
          </Routes>
        </main>
