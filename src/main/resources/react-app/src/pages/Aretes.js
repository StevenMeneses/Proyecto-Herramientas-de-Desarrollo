...
const Aretes = () => {
  ...
  const categoryId = 2; // ID para Aretes
  ...
  return (
    <div className="category-page">
      <div className="category-header">
        ...
        <h1 className="category-title">Aretes Elegantes</h1>
        <p className="category-subtitle">
          Encuentra los aretes perfectos que complementarán tu estilo único
        </p>
      </div>
      ...
      <div className="category-products-grid">
        {filteredProducts.length > 0 ? (
            ...
            <div key={product.idProducto} className="category-product-card jewel-sparkle">
              ...
              <div className="category-product-info">
                ...
                <div className="category-product-details">
                  ...
                  <span className="category-product-type">Aretes</span>
                </div>
          ...
          <div className="category-empty-state">
            ...
            <h3 className="category-empty-title">No se encontraron aretes</h3>
