...
const MataritaCollection = () => {
  ...
  useEffect(() => {
    ...
    const stored = localStorage.getItem('matarita-collection_products');
    if (stored) {
  ...
  const obtenerImagen = (imagePath) => {
    ...
    try {
      const imagenesGuardadas = JSON.parse(localStorage.getItem('matarita-collection_images') || '{}');
    ...
    <div className="sea-collection-container">
      ...
      <div className="hero-image-section">
        <div className="hero-image-container">
          {headerImage ? (
            <img src={headerImage} alt="Matarita Collection Header" className="hero-image" />
          ) : (
            <div className="hero-placeholder">
              Imagen destacada de Matarita Collection
            </div>
          )}
        </div>
        {currentUser.rol === 1 && (
        ...
        <div className="products-grid">
          ...
          {filteredProducts.length === 0 && (
            <div className="empty-state">
              ...
              <p className="empty-state-text">No se encontraron productos en Matarita Collection</p>
...
export default MataritaCollection;