...
const Aros = () => {
  ...
  const categoryId = 4; // ID para Aros
  ...
  return (
    <div className="category-page">
      <div className="category-header">
        ...
        <h1 className="category-title">Aros Modernos</h1>
        <p className="category-subtitle">
          Descubre nuestra exclusiva colección de aros con diseños contemporáneos
        </p>
      </div>
      ...
      <div className="category-products-grid">
        {filteredProducts.length > 0 ? (
            ...
            <div key={product.idProducto} className="category-product-card jewel-sparkle">
              ...
              <div className="category-product-info">
                ...
                <div className="category-product-details">
                  ...
                  <span className="category-product-type">Aros</span>
                </div>
          ...
          <div className="category-empty-state">
            ...
            <h3 className="category-empty-title">No se encontraron aros</h3>
